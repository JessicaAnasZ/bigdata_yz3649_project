function dashboard(id, fData) {
    ...
    function segColor(c) {
        // Update the following statement with your 5 words from HW3
        cmap = {word1: "#4753CC", word2: "#828499", word3: "#73C9FF", word4: "#CC6E47", word5: '#FFD4B3'};
        return /* TO FINISH */;
    }
    ...
    // Update the following array with your 5 words from HW3
    var tF = ['word1', 'word2', 'word3', 'word4', 'word5'].map(function (d) {
        return {
